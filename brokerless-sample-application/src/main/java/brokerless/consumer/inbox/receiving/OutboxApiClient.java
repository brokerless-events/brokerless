...
public class OutboxApiClient {
  ...
  public Stream<ReceivedEventMessage> fetchEvents(ProducerConfiguration producerConfiguration, Set<String> eventTypes, UUID fromCursorExclusive) {
    ...
    GetOutboxEventsRequest request = new GetOutboxEventsRequest(eventTypes, fromCursorExclusive);
